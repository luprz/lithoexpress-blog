    ...
    class Install
      class << self
        ...
        def copy_initializer_file
          ...
          copier.copy_file File.join(gem_path, 'lib/templates/keppler_blog.rb'), File.join(app_path, 'keppler_blog.rb')
        end
        ...
        def copy_files(directories, origin, destination)
          directories.each do |directory|
            Dir[File.join(origin, directory, 'keppler_blog', '**/*')].each do |file|
